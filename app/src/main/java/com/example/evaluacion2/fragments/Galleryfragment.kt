...
import kotlinx.android.synthetic.main.fragment_galleryfragment.view.*
...
class GalleryFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_galleryfragment, container, false).apply {
            iv_fragment.setImageResource(content!!.toInt())
        }
    }
